...
| 5     | [`sign-in`](./005-sign-in.md)                 | concluido | `auth-base`, `confirm-account` | Login email+senha+repetir telefone; bloqueia conta não confirmada (com reenvio); email de nova sessão; uma sessão válida por pessoa (última vence)                                                           |
| 6     | [`forgot-password`](./006-forgot-password.md) | concluido | `auth-base`                    | Solicita reset com email+telefone; se bater, envia token de reset por email com anti-enumeração                                                                                                              |
| 7     | [`reset-password`](./007-reset-password.md)   | concluido | `forgot-password`, `auth-base` | Define nova senha + confirmação (match); valida token; revoga sessões; email de sucesso; navega para sign-in                                                                                                 |
